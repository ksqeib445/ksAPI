...
public class MulNBT {
    ...
    public Object asCraftMirror(Object object) {
        Object obj = null;
        try {
            obj = getCraftItemStackClass().getMethod("asCraftMirror", getItemSatckClass()).invoke(null, new Object[]{object});
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return obj;
    ...
    public Object asCraftCopy(Object object) {
        Object obj = null;
        try {
            obj = getCraftItemStackClass().getMethod("asCraftCopy",ItemStack.class).invoke(null, new Object[]{object});
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return obj;
    ...
    public Object asNMSCopy(Object object) {
        Object obj = null;
        try {
            obj = getCraftItemStackClass().getMethod("asNMSCopy",ItemStack.class).invoke(null, new Object[]{object});
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return obj;
    ...
    public Object getItemStack(Object object) {
        ...
        Object obj = null;
        try {
            obj = getItemSatckClass().getConstructor(new Class[]{getNBTTagCompoundClass()}).newInstance(new Object[]{object});
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return obj;
