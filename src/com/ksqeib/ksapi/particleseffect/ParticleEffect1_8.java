...
public enum ParticleEffect1_8 {
    ...
    public static final class ParticlePacket {
        ...
        private final ParticleEffect1_8 effect;
        ...
        public ParticlePacket(ParticleEffect1_8 effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
            initialize();
            this.effect = effect;
        ...
        public ParticlePacket(ParticleEffect1_8 effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
        ...
        public static void initialize() {
            ...
            } catch (ClassNotFoundException | NoSuchMethodException | NullPointerException | IllegalArgumentException | SecurityException | NoSuchFieldException e) {
//                System.out.print("抱歉,此服务端无法使用NewCustomCuiLian的粒子模块，粒子模块已关闭");
//                SuitEffectListener.canUseParticlesEffect = false;
            }
            initialized = true;
        }
        ...
        private void initializePacket(Location center) {
            ...
            try {
                ...
                setValue(packet, true, "a", enumParticle.getEnumConstants()[effect.id]);
